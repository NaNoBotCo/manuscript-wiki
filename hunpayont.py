...
def _essay_en(s: dict) -> str:
    ...
    return (
        ...
        "</ol>"
        "<blockquote><p>The whole widget is one static page that runs in the "
        "reader's browser. Your khata is stored in <em>your</em> browser and "
        "encoded in <em>your</em> link.</p></blockquote>"
        ...
        "<li><b>The ledger is local.</b> No cookie, no pixel, no beacon, no third-party "
